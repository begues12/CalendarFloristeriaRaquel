...
@bp.route('/create_time_entry', methods=['GET', 'POST'])
@login_required
...
@bp.route('/edit_time_entry/<int:entry_id>', methods=['GET', 'POST'])
@login_required
@requires_privilege('can_manage_time_entries')
...
@bp.route('/delete_time_entry/<int:entry_id>', methods=['POST'])
@login_required
@requires_privilege('can_manage_time_entries')
